...
namespace FreeCourse.Services.Catalog.Services
{
    public class CourseService : ICourseService
    {
        ...
        {
            var courses = await _courseCollection.Find<Course>(a => a.UserId == userId).ToListAsync();
        ...
        public async Task<Response<NoContent>> UpdateAsync(CourseUpdateDto courseUpdateDto)
        {
            ...
            var result = await _courseCollection.FindOneAndReplaceAsync(a=>a.Id == courseUpdateDto.Id, updatedCourse);
